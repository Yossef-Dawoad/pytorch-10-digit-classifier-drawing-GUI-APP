export default class Arraygrid{
    constructor(dimensions,fillNumber){
        this.dimensions = dimensions // dimensions of the array
        this.setfillNumber = fillNumber
        this.inversefillNumber = (fillNumber==1) ? 0:1 ;   
        this.array  = this.fillWith(fillNumber) // fill the array
